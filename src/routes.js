...
import RecordInput from './Todo/RecordInput';
    ...
    <Router history={history}>
      <div className="container">
        ...
        <Route
          path="/recordinput"
          render={props =>
            provideClient(<RecordInput auth={auth} {...props} />)
          }
        />
        <Route
          path="/amrecordcollection"
          render={props => provideClient(<RecordInfo auth={auth} {...props} />)}
        />
        <Route
          path="/combinedrecords"
          render={props =>
